                    ...
                    <Grid item xs={12} md={5}>
                        <GlassCard>
                            ...
                            <form onSubmit={handleUpload}>
                                <Stack spacing={2.5}>
                                    <AppTextField fullWidth label="Document Title" placeholder="e.g., Semester 3 Marksheet" value={title} onChange={(e) => setTitle(e.target.value)} required />
                                    ...
                                    <FormControl fullWidth>
                                        ...
                                        <StyledSelect value={targetClass} label="Target Class (Optional)" onChange={(e) => setTargetClass(e.target.value)}>
                                    ...
                                    <AppTextField fullWidth label="Description (Optional)" placeholder="Brief description of the document" value={description} onChange={(e) => setDescription(e.target.value)} multiline rows={2} />

                                    <DropZone onClick={() => document.getElementById('file-input').click()}>
                                        <input id="file-input" type="file" hidden accept=".pdf,.doc,.docx,.xls,.xlsx,.jpg,.jpeg,.png,.webp" onChange={handleFileSelect} />
                                        {selectedFile ? (
                                            ...
                                            <Box sx={{ textAlign: 'center' }}>
                                                ...
                                                <Typography variant="caption" sx={{ color: 'rgba(226,232,255,0.3)' }}>PDF, DOC, XLS, JPG, PNG (Max 10MB)</Typography>
                                            </Box>
                                        )}
                                    </DropZone>
                        ...
                        <GlassCard>
                            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 1.5, mb: 3, flexWrap: 'wrap' }}>
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                                    ...
                                    <Box>
                                        <Typography variant="h6" sx={{ fontWeight: 800, color: '#F5F5FF', letterSpacing: '-0.02em', mb: '2px' }}>All Documents</Typography>
                                        <Typography variant="body2" sx={{ color: 'rgba(226,232,255,0.4)', fontSize: '0.75rem' }}>{documents.length} document{documents.length !== 1 ? 's' : ''} uploaded</Typography>
                                    </Box>
                                </Box>
                                <FormControl size="small" sx={{ minWidth: 130 }}>
                                    <StyledSelect value={filterCategory} onChange={(e) => setFilterCategory(e.target.value)} displayEmpty sx={{ fontSize: '0.8rem' }}>
                            ...
                            {loading ? (
                                ...
                                <EmptyState>
                                    ...
                                    <Typography variant="body2" sx={{ color: 'rgba(226,232,255,0.4)', fontWeight: 600 }}>No documents uploaded yet</Typography>
                                </EmptyState>
                            ) : (
                                <DocList>
                                    {filteredDocs.map((doc, idx) => (
                                        <DocCard key={doc._id || idx} delay={idx * 0.04}>
                                            ...
                                            <Box sx={{ flex: 1, minWidth: 0, p: '14px 16px' }}>
                                                ...
                                                {doc.description && (
                                                    <Typography variant="caption" sx={{ color: 'rgba(226,232,255,0.4)', display: 'block', mb: 0.5, lineHeight: 1.3 }}>{doc.description}</Typography>
                                                )}
                                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mt: 0.5 }}>
                                                    ...
                                                    {doc.file_name && (
                                                        <Typography variant="caption" sx={{ color: 'rgba(226,232,255,0.3)' }}>{doc.file_name}</Typography>
                                                    )}
                                                </Box>
                                            </Box>
