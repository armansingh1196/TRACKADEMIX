...
import { Box, Button, Collapse, IconButton, Table, TableBody, TableHead, TableRow, Typography, Tab, Container, CircularProgress, Avatar, TableContainer, Paper, Chip } from '@mui/material';
import TabContext from '@mui/lab/TabContext';
import TabList from '@mui/lab/TabList';
import TabPanel from '@mui/lab/TabPanel';
import { KeyboardArrowUp, KeyboardArrowDown, Delete as DeleteIcon, Add as AddIcon, Edit as EditIcon } from '@mui/icons-material';
...
const ViewStudent = () => {
    ...
    const StudentAttendanceSection = () => {
        const renderTableSection = () => {
            return (
                <GlassContainer>
                    <SectionHeader title="Attendance Records" currentView={selectedSection} onToggle={setSelectedSection} />
                                            ...
                                            <StyledTableCell align="center">
                                                <Box sx={{ display: 'flex', justifyContent: 'center', gap: 1 }}>
                                                    ...
                                                    <Button 
                                                        ...
                                                        sx={{ background: 'var(--gradient-vibrant)', color: 'white' }}
                                                    >
                                                        Change
                                                    </Button>
                                                    <IconButton size="small" onClick={() => removeSubAttendance(subId)} sx={{ color: '#f44336' }}>
                                                        <DeleteIcon />
                                                    </IconButton>
                                                </Box>
                                            </StyledTableCell>
                ...
                {subjectAttendance && Array.isArray(subjectAttendance) && subjectAttendance.length > 0
                    ...
                    : (
                        <EmptyStateCard>
                            ...
                            <Typography sx={{ color: 'var(--text-muted)', mb: 3 }}>This student does not have any attendance data logged yet.</Typography>
                            <AppButton variant="contained" startIcon={<AddIcon />} onClick={() => navigate("/Admin/students/student/attendance/" + studentID)} sx={{ background: 'var(--gradient-vibrant) !important' }}>
                                Add First Record
                            </AppButton>
                        </EmptyStateCard>
                    )
    ...
    const StudentMarksSection = () => {
        const renderTableSection = () => {
            return (
                <GlassContainer>
                    <SectionHeader title="Academic Performance" currentView={selectedSection} onToggle={setSelectedSection} />
                    <StyledTableContainer component={Paper} elevation={0}>
                        <Table>
                            <TableHead>
                                <TableRow>
                    ...
                    <Box sx={{ mt: 3, display: 'flex', justifyContent: 'flex-end' }}>
                        <AppButton variant="contained" startIcon={<AddIcon />} onClick={() => navigate("/Admin/students/student/marks/" + studentID)} sx={{ background: 'var(--gradient-vibrant) !important' }}>
                            Add Marks
                        </AppButton>
                    </Box>
                </GlassContainer>
                ...
                {subjectMarks && Array.isArray(subjectMarks) && subjectMarks.length > 0
                    ...
                    : (
                        <EmptyStateCard>
                            ...
                            <Typography sx={{ color: 'var(--text-muted)', mb: 3 }}>This student does not have any exam marks recorded yet.</Typography>
                            <AppButton variant="contained" startIcon={<AddIcon />} onClick={() => navigate("/Admin/students/student/marks/" + studentID)} sx={{ background: 'var(--gradient-vibrant) !important' }}>
                                Add Marks
                            </AppButton>
                        </EmptyStateCard>
                ...
                <Box sx={{ p: 4, pt: 0, display: 'flex', justifyContent: 'flex-end' }}>
                    <AppButton 
                        ...
                        sx={{ 
                            ...
                            boxShadow: '0 8px 16px rgba(244, 67, 54, 0.3) !important',
                        }}
                    >
                        Delete Student
                    </AppButton>
        ...
        <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            <HeaderBox>
                ...
                <Typography variant="body1" sx={{ color: 'var(--text-muted)' }}>
                    View and manage student profile, attendance, and performance records.
                </Typography>
            </HeaderBox>
